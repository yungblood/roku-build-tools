...
sub trackVideoLoad(video as object)
'    videoType = "episode"
'    if video.subtype() = "Movie" then
'        videoType = "movie"
'    else if video.isLive then
'        videoType = "live"
...
'    
'    initializeAdobe()
'    m.adobe.mediaTrackLoad(m.mediaInfo, {})
end sub
...
sub trackAdBreakStart()
'    initializeAdobe()
''    m.adobe.mediaTrackEvent("MEDIA_AD_BREAK_START")
end sub

sub trackAdBreakComplete()
'    initializeAdobe()
''    m.adobe.mediaTrackEvent("MEDIA_AD_BREAK_COMPLETE")
end sub

sub trackAdStart()
'    initializeAdobe()
''    m.adobe.mediaTrackEvent("MEDIA_AD_START")
end sub

sub trackAdComplete()
'    initializeAdobe()
''    m.adobe.mediaTrackEvent("MEDIA_AD_COMPLETE")
end sub
